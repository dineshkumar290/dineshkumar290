...
- 🌍 API integrations with Node.js + Express
...
|--------|-------------|------|
| [PolyTalk](https://github.com/your-github-username/PolyTalk) | 🗣️ Wearable AI Translator & Companion | Python, Raspberry Pi, TTS, STT |
| [Face Recognition Attendance](https://github.com/your-github-username/face-recognition-attendance) | 🎓 AI-based attendance system | Python, OpenCV, SemasisNet |
| [Obstacle Avoiding Robot](https://github.com/your-github-username/obstacle-avoiding-robot) | 🤖 Basic autonomous robot using ultrasonic sensor | Arduino, C, L293D |
